function Footer() {
    ...
    return (
        <div className="w-full h-24 flex justify-evenly items-center mb-10">
            ...
            <div className="w-full md:w-[90%] mx-auto flex mt-4 md:mt-0 flex-col md:flex-row justify-between items-center gap-2 md:gap-4 text-center md:text-left">
