        ...
        <div className="w-full border-b-2 border-dashed py-16 relative ">
            ...
            <div className="flex mt-12 relative">
                <img
                    ...
                    className="absolute w-16 z-50 top-4 left-12 md:w-24 md:left-20 lg:left-[16%] h-auto hover:cursor-pointer hover:scale-110 transition-transform duration-200"
                />
                <img
                    src="/convoBubble.svg"
                    alt="Text bubble icon"
                    onClick={playMessageSound}
                    className="absolute w-20 z-50 -top-4 right-8 md:w-32 md:right-24 md:-top-8 lg:right-[16%] h-auto hover:cursor-pointer hover:scale-110 transition-transform duration-200"
                />
            </div>
        </div>
    );
