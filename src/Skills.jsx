...
function Skills() {
    ...
    return (
        <div className="w-full border-b-2 border-dashed py-16 relative dark dark:bg-gradient-to-b dark:from-zinc-700 dark:via-black dark:to-zinc-600
                dark:border-white">
            ...
            <div className="w-[85%] mx-auto pt-7 md:w-[90%] md:-mb-10 lg:w-[78%] lg:-mb-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-4 text-xl justify-items-center lg:pt-10">
                    ...
                    <div className="rounded-xl shadow-xl bg-white border border-gray-300
                     ...
                     lg:hover:scale-105 transition-transform duration-200 cursor-pointer dark:bg-zinc-500 dark:border-zinc-500 dark:text-gray-200
                     dark:[box-shadow:inset_0_0_10px_rgba(255,255,255,0.5),_0_0_25px_rgba(255,255,255,0.5)]">
                    ...
                    <div className="rounded-xl shadow-xl bg-white border border-gray-300 w-[90%]
                     ...
                     dark:border-zinc-500 dark:text-gray-200 dark:[box-shadow:inset_0_0_10px_rgba(255,255,255,0.5),_0_0_25px_rgba(255,255,255,0.5)]">
