        ...
        <div className="w-full border-b-2 border-dashed py-16 relative">
            ...
            <div className="flex mt-12 relative">
                <img
                    ...
                    className="absolute w-30 left-64 h-auto hover:cursor-pointer hover:scale-110 transition-transform duration-200"
                />
                <img
                    src="/convoBubble.svg"
                    alt="Text bubble icon"
                    onClick={playMessageSound}
                    className="absolute w-38 right-60 -top-8 h-auto hover:cursor-pointer hover:scale-110 transition-transform duration-200"
                />
            </div>
        </div>
    );
